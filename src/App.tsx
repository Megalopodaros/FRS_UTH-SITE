...
export default function App() {
  ...
  const t = {
    gr: {
      ...
      eventsDesc: "Τα πάρτι του FRS UTH. Δυνατή μουσική, καλή παρέα και χορός μέχρι το πρωί.",
    ...
    en: {
      ...
      eventsDesc: "FRS UTH parties. Loud music, good company, and dancing until morning.",
      openCallBadge: "OPEN CALL 2026",
