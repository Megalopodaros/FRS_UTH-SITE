...
export default function App() {
  ...
  const t = {
    gr: {
      ...
      heroTitle1: "Φοιτητικό Ραδιόφωνο",
      heroPrefix: "στο ",
      heroTitle2: "Πανεπιστήμιο Θεσσαλίας.",
      heroSub: "Εκπομπές, μουσικές και συζητήσεις από φοιτητές για φοιτητές. Ακούστε ζωντανά online 24 ώρες το 24ωρο ή μπείτε στο live chat.",
    ...
    en: {
      ...
      heroTag: "LIVE ON AIR • 24/7 ONLINE STREAM",
      heroTitle1: "Student Radio at the",
      heroPrefix: "",
      heroTitle2: "University of Thessaly.",
      heroSub: "Shows, music, and talks made by students, for students. Listen live online 24/7 or join the live chat.",
