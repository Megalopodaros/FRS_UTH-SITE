...
export default function App() {
  ...
  const t = {
    gr: {
      ...
      eventsDesc: "Τα πάρτι του FRS UTH. Καλή μουσική, φοιτητικά vibes και χορός μέχρι το πρωί σε όλες τις πόλεις.",
    ...
    en: {
      ...
      eventsDesc: "FRS UTH parties. Good music, student vibes, and dancing until morning across all cities.",
      openCallBadge: "OPEN CALL 2026",
