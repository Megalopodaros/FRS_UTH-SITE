...
export default function App() {
  ...
  const t = {
    gr: {
      ...
      eventsDesc: "Τα θρυλικά πάρτι του FRS UTH. Εκρηκτικά beats, κατάμεστα dancefloors και φοιτητικές βραδιές που γράφουν ιστορία σε κάθε πόλη του Πανεπιστημίου.",
    ...
    en: {
      ...
      eventsDesc: "The legendary FRS UTH parties. Explosive beats, packed dancefloors, and unforgettable student nights across every university city.",
      openCallBadge: "OPEN CALL 2026",
