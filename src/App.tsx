...
export default function App() {
  ...
  const t = {
    gr: {
      ...
      footerDesc: "Φοιτητικός Ραδιοφωνικός Σταθμός Πανεπιστημίου Θεσσαλίας. Αυτόνομη έκφραση, μουσική και επικοινωνία φοιτητών από το 2022.",
    ...
    en: {
      ...
      applyNow: "Apply Now",
      footerDesc: "Student Radio Station of the University of Thessaly. Autonomous expression, music, and student connection since 2022.",
